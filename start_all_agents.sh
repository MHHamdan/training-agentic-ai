...
echo ""
echo "16. Starting Feedback Analysis System..."
start_agent "Feedback Analysis System" "agents/feedback-analysis-system/app.py" "8515"
...
echo "🎯 Feedback Analysis:           http://localhost:8515"
echo ""
